...
class TelemetryListener(Node):
    def __init__(self):
        ...
        self.subscription = self.create_subscription(
            ...
            self.image_callback,
            10  
        ) ## sensor_msgs/msg/CompressedImage olarak değişecek 
        ...
        # self.nav_action_client = ActionClient(self, NavigateToPose, '/navigate_to_goal') ##navigation will not active, currently 
